                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table">
                                ...
                                <tbody>';
        $conn = connect();
        $query = "SELECT id, tytul, zdjecie, cena_netto FROM produkty ORDER BY id DESC LIMIT 100";
        $stmt = $conn->prepare($query);
        $stmt->execute();
        $stmt->bind_result($id, $tytul, $zdjecie, $cena_netto);
        ...
        echo '
            <form method="POST">
                <tr>
                    ...
                    <td>' . htmlspecialchars($cena_netto) . '</td>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <textarea style="width: 1000px;height: 300px;" id="update_opis" name="update_opis">' . htmlspecialchars($opis). ' </textarea>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea style="width: 1000px;height: 300px;" id="add_opis" name="add_opis"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="add_cena_netto">Cena netto:</label>
                                <input type="number" id="add_cena_netto" name="add_cena_netto">
                            </div>
                            <div class="mb-3">
                                <label for="add_podatek_vat">Podatek VAT:</label>
                                <input type="number" id="add_podatek_vat" name="add_podatek_vat">
                            </div>
                            <div class="mb-3">
                                <label for="add_ilosc_dostepnych_sztuk">Ilość dostępnych sztuk:</label>
                                <input type="number" id="add_ilosc_dostepnych_sztuk" name="add_ilosc_dostepnych_sztuk">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="add_kategoria">Kategoria:</label>
                                <input type="number" id="add_kategoria" name="add_kategoria">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="submit" name="submit_add" class="btn btn-primary" value="potwierdź">
                            </div>
                        </form>
                    </div>
                </div>
...
<?php
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin']) {
    header("loctaion: {$_SERVER['PHP_SELF']}");
    ListaProduktow();
